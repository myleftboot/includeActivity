...
@interface includeActivityObject : KrollCoverageObject {
#else
@interface includeActivityObject : KrollObject {
#endif
@private
...
extern NSString * includeActivity$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	includeActivityObject *_includeactivity;
    KrollObject* console;
	BOOL shutdown;
