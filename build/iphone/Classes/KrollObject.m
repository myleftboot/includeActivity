 ...
 * Copyright (c) 2009-2011 by includeActivity, Inc. All Rights Reserved.
...
//@interface includeActivityObject : NSObject
//@end

@interface includeActivityObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[includeActivityObject class]])
		{
			for (NSString *key in [[(includeActivityObject*)o modules] allKeys])
			{
