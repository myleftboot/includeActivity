...
// in simulator we redefine to format for includeActivity Developer console
...
{\
	NSString * exceptionName = [@"org.includeactivity." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.includeactivity";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIincludeActivityNativeItemNone = -1, 
	UIincludeActivityNativeItemSpinner = -2,
	UIincludeActivityNativeItemProgressBar = -3,
	
	UIincludeActivityNativeItemSlider = -4,
	UIincludeActivityNativeItemSwitch = -5,
	UIincludeActivityNativeItemMultiButton = -6,
	UIincludeActivityNativeItemSegmented = -7,
	
	UIincludeActivityNativeItemTextView = -8,
	UIincludeActivityNativeItemTextField = -9,
	UIincludeActivityNativeItemSearchBar = -10,
	
	UIincludeActivityNativeItemPicker = -11,
	UIincludeActivityNativeItemDatePicker = -12,
	
	UIincludeActivityNativeItemInfoLight = -13,
	UIincludeActivityNativeItemInfoDark = -14,
	
	UIincludeActivityNativeItemDisclosure = -15,
	
	UIincludeActivityNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all includeActivity instances of
