...
//Rare exceptions to indicate a bug in the _includeactivity code (Eg, function that a subclass should have implemented)
...
/**
 The base class for includeActivity proxies.
 */
