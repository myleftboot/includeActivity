...
/**
 Base class for all includeActivity views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the includeActivity view hierarchy (such as wrapped iOS UIViews) was touched.
